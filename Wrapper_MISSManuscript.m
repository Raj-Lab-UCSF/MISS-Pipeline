...
%pipeline results using the Tasic, et al., 2018 scRNAseq dataset, and then
%proceeding to the rest of the figures, including the generating the data 
...
ng_param_list = 3849; %values of nG to test and map, going through genes in MRx3 ranked order
...
savename = 'CellDensity_Tasic_allnG.mat'; %set name of file to be saved
