...
if strcmp(method_,'MRx3')
    preloadinds = MRx3_Selector_Prefilter(genevct_,voxvgene_,nG_total,lambda_);
else
    preloadinds = [];
end
...
[E_red,C_red] = GeneSelector(genevct_,voxvgene_,gene_names_,nG_param_opt,lambda_,method_,preloadinds);
