...
ng_param_list = [1020:20:1500,1550:50:2200]; %values of nG to test and map, going through genes in MRx3 ranked order
...
savename = 'CellDensity_Yao2021_medrange.mat'; %set name of file to be saved
